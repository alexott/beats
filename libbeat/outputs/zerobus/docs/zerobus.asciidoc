...
Number of events to batch together before sending. Default: 1.

*Important:* The Zerobus API currently requires `batch_size: 1` for JSON mode. This is an API limitation, not a limitation of the output implementation.
